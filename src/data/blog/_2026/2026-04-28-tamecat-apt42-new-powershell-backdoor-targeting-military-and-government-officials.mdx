...
tags: ['apt42', 'tamecat', 'powershell', 'malware-analysis', 'threat-intelligence', 'incident-response', 'fileless-malware', 'iran', 'espionage', 'telegram-c2', 'vbscript', 'phishing', 'nation-state', 'cyberwarfare']
