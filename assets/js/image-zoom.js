(function () {
  ...
  function openFrom(img) {
    ...
    overlay.setAttribute("aria-label", "Image preview, swipe left/right to switch, click to zoom, scroll to scale, drag to pan");
    ...
    hint.textContent = "Click to zoom · Scroll to scale · Drag to move · Esc to close";
